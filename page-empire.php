                ...
                <div class="entry">
                    <div class="image-list">
                        <div class="single-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/thema/empire.png" alt="">
                        </div>
                        <div class="iphone-wrapper">
                            <div class="iphone">
                                <div class="iphone__screenshot">
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/thema/empire_sp.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="article-detail">
                        <div class="title">
                            <p class="textm">Empire</p>
                            <span class="demo_link"><a href="https://themes.shopify.com/themes/empire/styles/supply/preview?architecture%5B%5D=os2&surface_detail=empire&surface_inter_position=1&surface_intra_position=1&surface_type=search">デモサイトを見る</a>
                            </span>
                            <p class="price">$300</p>
                        </div>
                ...
                <div class="article-content">
                    ...
                    <div class="tab_content" id="feature_content">
                        <div class="tab_content_description">
                            <p>特徴</p>
                            <ul>
                                <li>・大規模ECサイト向けに最適化されたAmazon風の有料Shopifyテーマ</li>
                                <li>・ユーザーが多数の商品の中から簡単にお目当の商品を見つけられるように、トップページにメニューリストを表示</li>
                                <li>・さまざまなアプリとの連携も可能</li>
                                <li>・スマホレイアウトのフィルタ機能が直感的で使いやすいデザイン</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="tab_content" id="case_study_content">
                        <div class="tab_content_description">
                            <p>事例</p>
                            <ul>
                                <li><a href="https://beardoctane.com/pages/raffle-ticket-event">https://beardoctane.com/pages/raffle-ticket-event</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
