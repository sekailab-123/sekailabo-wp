                ...
                <div class="entry">
                    <div class="image-list">
                        <div class="single-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/thema/california.png" alt="">
                        </div>
                        <div class="iphone-wrapper">
                            <div class="iphone">
                                <div class="iphone__screenshot">
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/thema/california_sp.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="article-detail">
                        <div class="title">
                            <p class="textm">California</p>
                            <p class="demo_link"><a href="https://themes.shopify.com/themes/california/styles/generic/preview?architecture%5B%5D=os2&surface_detail=california&surface_inter_position=1&surface_intra_position=1&surface_type=search">デモサイトを見る</a>
                            </p>
                        </div>
                        <p class="price">$240</p>
                ...
                <div class="article-content">
                    ...
                    <div class="tab_content" id="feature_content">
                        <div class="tab_content_description">
                            <p>特徴</p>
                            <ul>
                                <li>・数多くのアート作品を取り扱っているショップに最適なテーマ</li>
                                <li>・高度な商品絞り込み機能やホームページのコレクショングリッド表示を備えた、すっきりしたシンプルなデザインが特徴</li>
                                <li>・複数のコレクションからおすすめ作品を特集できる、閲覧しやすいページも魅力</li>
