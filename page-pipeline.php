                ...
                <div class="entry">
                    <div class="image-list">
                        <div class="single-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/thema/pipeline.png" alt="">
                        </div>
                        <div class="iphone-wrapper">
                            <div class="iphone">
                                <div class="iphone__screenshot">
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/thema/pipeline_sp.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="article-detail">
                        <div class="title">
                            <p class="textm">Pipeline <span class="demo_link"><a href="https://themes.shopify.com/themes/pipeline/styles/bright/preview?architecture%5B%5D=os2&surface_detail=pipeline&surface_inter_position=1&surface_intra_position=1&surface_type=search">デモサイトを見る</a>
                                </span></p>
                            <p class="price">$280</p>
                        </div>
                ...
                <div class="article-content">
                    ...
                    <div class="tab_content" id="feature_content">
                        <div class="tab_content_description">
                            <p>特徴</p>
                            <ul>
                                <li>・トップページに掲載するコレクションの切り替え、品ページのタブ切り替えなど、多くの情報を綺麗にまとめることができるテーマ</li>
                                <li>・検索バーでは検索候補(サジェスト)が表示されるため、商品へのアクセスもしやすい仕様</li>
                                <li>・またカート画面上で住所を入力することで配送料を事前に計算する機能などもあります</li>
                                <li>・大量店舗（特定の期間に多数のトランザクションを処理するストア向けに設計されています）</li>
                                <li>・国際的な販売（地域の境界を越えて販売する店舗向けに設計されています</li>
                    ...
                    <div class="tab_content" id="case_study_content">
                        <div class="tab_content_description">
                            <p>事例</p>
                            <ul>
                                <li><a href="https://tea-hatoha.com/">
                                        https://tea-hatoha.com/</a></li>
                                <li><a href="https://windandsea.jp/">https://windandsea.jp/</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
