                ...
                <div class="entry">
                    <div class="image-list">
                        <div class="single-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/thema/galleria.png" alt="">
                        </div>
                        <div class="iphone-wrapper">
                            <div class="iphone">
                                <div class="iphone__screenshot">
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/thema/galleria_sp.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="article-detail">
                        <div class="title">
                            <p class="textm">Galleria <span class="demo_link"><a href="https://themes.shopify.com/themes/galleria/styles/empire/preview?architecture%5B%5D=os2&surface_detail=galleria&surface_inter_position=1&surface_intra_position=1&surface_type=search">デモサイトを見る</a>
                                </span></p>
                            <p class="price">$250</p>
                        </div>
                ...
                <div class="article-content">
                    ...
                    <div class="tab_content" id="feature_content">
                        <div class="tab_content_description">
                            ...
                            <ul>
                                <li>・アパレル向け</li>
                                <li>・ワードローブにあるアイテムをすべて取り扱っているような、商品群の多いショップにぴったりなテーマ</li>
                                <li>・サイドバーのコレクション絞り込み機能をはじめ、商品のクイックビューや画像中心の大胆な商品ページなど、商品を見つけやすく細部まで確認できる機能をバランスよく取り揃えています
                                </li>
