                ...
                <div class="entry">
                    <div class="image-list">
                        <div class="single-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/thema/emerge.png" alt="">
                        </div>
                        <div class="iphone-wrapper">
                            <div class="iphone">
                                <div class="iphone__screenshot">
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/thema/emerge_sp.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="article-detail">
                        <div class="title">
                            <p class="textm">Emerge <span class="demo_link"><a href="https://themes.shopify.com/themes/emerge/styles/light/preview?architecture%5B%5D=os2&surface_detail=emerge&surface_inter_position=1&surface_intra_position=1&surface_type=search">デモサイトを見る</a>
                                </span></p>
                            <p class="price">$250</p>
                        </div>
                ...
                <div class="article-content">
                    ...
                    <div class="tab_content" id="feature_content">
                        <div class="tab_content_description">
                            <p>特徴</p>
                            <ul>
                                <li>・現代的で洗練された（広々としたすっきりとしたレイアウト、没入型の大きな画像セクション、大胆で洗練されたタイプで、店舗に現代的なエッジを与えます。）</li>
                                <li>・強力なプロモーション機能（複数のコレクションページで販売、割引、注目の商品を宣伝して、発見可能性を高め、コンバージョンを促進します。）</li>
                                <li>・スケールに合わせて構築（ビジネスを開始、成長、拡大するための機能が搭載されており、実行中も見栄えがします。）</li>
