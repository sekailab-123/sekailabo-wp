                ...
                <div class="entry">
                    <div class="image-list">
                        <div class="single-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/thema/focal.png" alt="">
                        </div>
                        <div class="iphone-wrapper">
                            <div class="iphone">
                                <div class="iphone__screenshot">
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/thema/focal_sp.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="article-detail">
                        <div class="title">
                            <p class="textm">Focal <span class="demo_link"><a href="https://themes.shopify.com/themes/focal/styles/carbon/preview?architecture%5B%5D=os2&surface_detail=focal&surface_inter_position=1&surface_intra_position=1&surface_type=search">デモサイトを見る</a>
                                </span></p>
                            <p class="price">$300</p>
                        </div>
                    ...
                    <div class="tab_content" id="feature_content">
                        <div class="tab_content_description">
                            ...
                            <ul>
                                ...
                                <li>・ファーストビューのアニメーションの挙動が独特であるため、ユーザーの印象に残るサイトを構築</li>
                                <li>・タブ切替が可能（カテゴリーが多いストアに有効）</li>
                                <li>・コーディネートで訴求しマウスポインタで商品ダイレクト遷移が可能</li>
                                <li>・アニメーションを取り入れたパララックス効果も期待できる</li>
                            </ul>
                        </div>
                    </div>
