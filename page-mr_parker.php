                ...
                <div class="entry">
                    <div class="image-list">
                        <div class="single-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/thema/mr_parker.png" alt="">
                        </div>
                        <div class="iphone-wrapper">
                            <div class="iphone">
                                <div class="iphone__screenshot">
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/thema/mr_parker_sp.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="article-detail">
                        <div class="title">
                            <p class="textm">Mr Parke<span class="demo_link"><a href="https://themes.shopify.com/themes/mr-parker/styles/wardrobe/preview?architecture%5B%5D=os2&surface_detail=mr-parker&surface_inter_position=1&surface_intra_position=1&surface_type=search">デモサイトを見る</a>
                                </span>r</p>
                            <p class="price">$300</p>
                        </div>
                ...
                <div class="article-content">
                    ...
                    <div class="tab_content" id="feature_content">
                        <div class="tab_content_description">
                            <p>特徴</p>
                            <ul>
                                <li>・ホームウェア・ホーム／ガーデン業界向け</li>
                                <li>・商品数が中程度のショップにぴったりなテーマの「Mr. Parker」</li>
                                <li>・商品絞り込み機能やサイドバーを備えているため、コレクションページをアレンジすることができる</li>
                                <li>・ショップ全体をくまなくチェックしたいお客様でも、お探しのアイテムがきっと見つかるはず</li>
