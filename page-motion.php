                ...
                <div class="entry">
                    <div class="image-list">
                        <div class="single-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/thema/motion.png" alt="">
                        </div>
                        <div class="iphone-wrapper">
                            <div class="iphone">
                                <div class="iphone__screenshot">
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/thema/motion_sp.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="article-detail">
                        <div class="title">
                            <p class="textm">Motion <span class="demo_link"><a href="https://themes.shopify.com/themes/motion/styles/classic/preview?architecture%5B%5D=os2&surface_detail=motion&surface_inter_position=1&surface_intra_position=1&surface_type=search">デモサイトを見る</a>
                                </span></p>
                            <p class="price">$300</p>
                        </div>
                ...
                <div class="article-content">
                    ...
                    <div class="tab_content" id="feature_content">
                        <div class="tab_content_description">
                            <p>特徴</p>
                            <ul>
                                <li>・高級なブランド品などに向いているテーマ</li>
                                <li>・アパレル販売におすすめ</li>
                                <li>・シンプルで落ち着いたデザイン</li>
                                <li>・対面販売を行う店舗向けに設計</li>
                                <li>・将来的に越境ECを検討されている方にもおすすめ</li>
                                <li>・Shopify公式サイトでも93％という高い満足度</li>
                                <li>・三種類の中から選べる当テーマは商品を細かいところまで見せたい方にはおすすめ</li>
                            </ul>
                        </div>
                    </div>
                    <div class="tab_content" id="function_content">
                        <div class="tab_content_description">
                            ...
                            <ul class="function-list">
                                <li>・拡大する画像</li>
                                <li>・画像のホットスポットリンク</li>
                                <li>・Instagramの写真を貼り付けられる</li>
                                <li>・スライダー形式に商品画像を掲載</li>
                                <li>・スライドアウトカート</li>
                                <li>・カートノート</li>
                                <li>・店内ピックアップ</li>
                                <li>・スライド式カート</li>
