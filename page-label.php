                ...
                <div class="entry">
                    <div class="image-list">
                        <div class="single-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/thema/label.png" alt="">
                        </div>
                        <div class="iphone-wrapper">
                            <div class="iphone">
                                <div class="iphone__screenshot">
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/thema/label_sp.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="article-detail">
                        <div class="title">
                            <p class="textm">Label<span class="demo_link"><a href="https://themes.shopify.com/themes/label/styles/music/preview?architecture%5B%5D=os2&surface_detail=label&surface_inter_position=1&surface_intra_position=1&surface_type=search">デモサイトを見る</a>
                                </span></p>
                            <p class="price">$250</p>
                        </div>
                ...
                <div class="article-content">
                    ...
                    <div class="tab_content" id="feature_content">
                        <div class="tab_content_description">
                            <p>特徴</p>
                            <ul>
                                <li>・厳選した少量の作品を掲載するための、オリジナリティあふれるテーマ </li>
                                <li>・小型カタログを取り扱う現代的なデザイナーやディーラー向けに構築された「Label」がおすすめ</li>
                                <li>・主力作品を全幅表示し、前面中央にレイアウトすることで、ショップを訪れた人の視線を引きつける</li>
                                <li>・実店舗（対面販売lを行う店舗向けに設計</li>
                                <li>・デジタル製品（非物理的製品の販売をサポートします）</li>
                            </ul>
                        </div>
                    </div>
