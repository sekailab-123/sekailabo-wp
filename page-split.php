                ...
                <div class="entry">
                    <div class="image-list">
                        <div class="single-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/thema/split.png" alt="">
                        </div>
                        <div class="iphone-wrapper">
                            <div class="iphone">
                                <div class="iphone__screenshot">
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/thema/split_sp.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="article-detail">
                        <div class="title">
                            <p class="textm">Split<span class="demo_link"><a href="https://themes.shopify.com/themes/split/styles/cuber/preview?architecture%5B%5D=os2&surface_detail=split&surface_inter_position=1&surface_intra_position=1&surface_type=search">デモサイトを見る</a>
                                </span></p>
                            <p class="price">$250</p>
                        </div>
                ...
                <div class="article-content">
                    ...
                    <div class="tab_content" id="feature_content">
                        <div class="tab_content_description">
                            <p>特徴</p>
                            <ul>
                                <li>・縦型のスライドとなっているため、商品に対して画像をより多く使用したい場合におすすめのテーマ</li>
                                <li>・インスタグラムのアカウントを埋め込むことが出来る</li>
                                <li>・インスタグラムにて商品の情報を発信しているショップにもおすすめできるテーマ</li>
                            </ul>
                        </div>
                    </div>
